...
export function Hero() {
  return (
    <section className="min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-24 py-20 relative overflow-hidden">
      <div className="absolute top-1/4 right-1/4 w-72 h-72 bg-primary/20 dark:bg-primary/5 rounded-full blur-3xl pointer-events-none hidden md:block" />
      <div className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-primary/15 dark:bg-primary/3 rounded-full blur-3xl pointer-events-none hidden md:block" />
